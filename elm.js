...
var author$project$Main$default = {books: 0};
...
var author$project$Main$viewSocialShare = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('mbl')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('wishlistShare mrm mts social-buttons ui-inlineBlock')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('social-buttons_label')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('mll')
								]),
							_List_fromArray(
								[
									A2(
...
var author$project$Main$viewWishListTable = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('wishlist-table mtl')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui-borderTop ui-grid ui-gridFull')
				]),
			_List_fromArray(
				[
					A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('itm-wishlistImg'),
												...
												[
													...
													_List_fromArray(
														[
															...
															elm$html$Html$Attributes$height(108)
														]),
													_List_Nil)
												]))
										])),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$text('The Executive')
														]))
												])),
											A2(
											elm$html$Html$p,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('itm-oos itm-time'),
															elm$html$Html$Attributes$href('#')
														]),
													_List_fromArray(
														[
															elm$html$Html$text('Wrap Cullotes')
														]))
												])),
											A2(
											elm$html$Html$div,
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('price-box')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('price-box__regular-price')
														]),
													_List_fromArray(
														[
															A2(
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('emptyColumn')
										]),
									_List_Nil),
									A2(
									elm$html$Html$td,
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('l-main box-bgcolor')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('title-bar pal box')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('b-account__title lfloat')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('My Wishlist')
							]))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('b-wishlist__list pll prl')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{init: author$project$Main$default, update: author$project$Main$update, view: author$project$Main$view});
